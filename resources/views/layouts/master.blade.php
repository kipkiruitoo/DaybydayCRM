...
<!-- /#sidebar-wrapper -->
    ...
    <nav id="myNavmenu" class="navmenu navmenu-default navmenu-fixed-left offcanvas-sm" role="navigation">
        <div class="list-group panel">
            <p class=" list-group-item siderbar-top" title=""><img  height="100" width="100"  src="{{url('images/daybyday-logo-white.png')}}" alt="" style=" margin: 1em 0;"></p>
